...
namespace SCADAutoRunner
{
    ...
    static class User32
    {
        ...
        public static extern int SendMessageTVI(IntPtr hWnd, int wMsg, int wParam, ref TVItem tvi);

        [DllImport("kernel32.dll", SetLastError = true)]
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool WriteProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, [MarshalAs(UnmanagedType.AsAny)] object lpBuffer,
